...
function Kpi131() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi131', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>1.3.1 / O‘quv va o‘quv-uslubiy ishlar /</Typography>
        <Typography variant='h6'>O‘quv qo‘llanma chop etilganligi</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='O‘quv qo‘llanma hammualliflikda yozilganda hamualliflar soni 2 nafar bo‘lsa har biriga 1-balldan' />
          <CardContent>
