...
function Kpi162() {
  ...
  const uploadFile = async data => {
    ...
    try {
      const response = await fetch('/api/kpi162', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>1.6.2 / O‘quv va o‘quv-uslubiy ishlar /</Typography>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Hamma tillar uchun (nomutaxassis) -kamida B2 va undan yuqori darajadagi til bilish sertifikatiga ega bo‘lsa 0-2,5 ball' />
          <CardContent>
