...
function Kpi421() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi421', {
        method: 'POST',
        body: formData
      })
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          4.2.1 / Ma‘naviy-ma‘rifiy ishlar hamda mehnat va ijro intizomiga rioya etish/
        </Typography>
        <Typography variant='h6'>
          OAV yoki ijtimoiy tarmoqlarda universitet va mamlakatda amalga oshirilayotgan islohotlar yuzasidan chiqishlar
          qilganligi, xorijda targ‘ib qilish va matbuot anjumani tashkil qilish, saylovlarda ishtirok etganligi
        </Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Professor-o‘qituvchi tomonidan OAV yoki gazeta, jurnallarda chiqish qilish yoki maqola chop etish: 0-2 ball' />
          <CardContent>
