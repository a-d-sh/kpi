...
function Kpi211() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi211', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>2.1.1 / Ilmiy va innovatsiyalarga oid ishlar /</Typography>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        id='typeInput'
                        label='Chop etilgan maqola bazasini kiriting'
                        placeholder='Chop etilgan maqola bazasi'
