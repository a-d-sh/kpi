...
const types = [
  `Universitet o‘qituvchilarining turli darajadagi va ko‘rinishdagi tarjima jarayonlariga jalb etilganligi`
]
...
function Kpi35() {
  ...
  const uploadFile = async data => {
    ...
    try {
      const response = await fetch('/api/kpi35', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>3.5 / Xalqaro hamkorlikka oid ishlar /</Typography>
        <Typography variant='h6'>
          Universitet o‘qituvchilarining tarjima jarayoniga jalb etilganliklari uchun
        </Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
