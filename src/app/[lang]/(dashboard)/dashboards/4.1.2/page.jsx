...
function Kpi412() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi412', {
        method: 'POST',
        body: formData
      })
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          4.1.2 / Ma‘naviy-ma‘rifiy ishlar hamda mehnat va ijro intizomiga rioya etish/
        </Typography>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Professor-o‘qituvchi raxbarligida turli xil tanlov yoki sport musobaqalarida ishtirok etgan talabalarga raxbarlik qilish: 0-2 ball' />
          <CardContent>
