...
function Kpi221() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi221', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>2.2.1 / Ilmiy va innovatsiyalarga oid ishlar /</Typography>
        <Typography variant='h6'>OAK ro‘yxatidagi jurnallarda maqola chop etganligi</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        id='typeInput'
                        label='Chop etilgan maqola ilmiy jurnal nomini kiriting'
                        placeholder='Chop etilgan maqola ilmiy jurnal nomi'
