...
function Kpi112() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi112', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>1.1.2 / O‘quv va o‘quv-uslubiy ishlar /</Typography>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Ikkitagacha fan kontentining bir qismini tayyorlaganligi uchun – 2 ball' />
          <CardContent>
