...
function Kpi132() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi132', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>1.3.2 / O‘quv va o‘quv-uslubiy ishlar /</Typography>
        <Typography variant='h6'>O‘quv qo‘llanma chop etilganligi</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='O‘quv qo‘llanma hammualliflikda yozilganda hamualliflar soni 2 nafardan ortiq bo‘lsa har biriga 0.5- balldan' />
          <CardContent>
