...
const types = [`PhD ilmiy darajasini olganlik`, `DSc ilmiy darajasini olganlik`]
...
function Kpi32() {
  ...
  const uploadFile = async data => {
    ...
    try {
      const response = await fetch('/api/kpi32', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>3.2 / Xalqaro hamkorlikka oid ishlar /</Typography>
        <Typography variant='h6'>
          Shuningdek, Dunyoning nufuzli OTMlarning PhD yoki DSc ilmiy darajasini olgan proffessor-o‘qituvchilar soni
        </Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
                  ...
                  <label>
                    ...
                    <StyledFileOneInputContainer>
                      {selectedFileone ? (
                        ...
                        <span>ilmiy darajalari diplomi va korachkadan pdf shakldagi nusxasi</span>
                      )}
                    </StyledFileOneInputContainer>
                  </label>
                </Grid>
