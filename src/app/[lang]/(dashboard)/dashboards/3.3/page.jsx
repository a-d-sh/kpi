...
const types = [
  `Loyixani 2023-2024 o‘quv yili davomida yutib olganlik`,
  `Loyixani 2022-yil davomida yutib olgan va xanuzgacha davom etayotganlik va yangi loyixalarda ishtirok etayotganlik`
]
...
function Kpi33() {
  ...
  const uploadFile = async data => {
    ...
    try {
      const response = await fetch('/api/kpi33', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>3.3 / Xalqaro hamkorlikka oid ishlar /</Typography>
        <Typography variant='h6'>Universitet proffessor o‘qituvchilarining xalqaro grandlarda ishtiroki</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
                  ...
                  <label>
                    ...
                    <StyledFileOneInputContainer>
                      {selectedFileone ? (
                        ...
                        <span>Loyixa yutganligi xaqidagi xujjatni pdf shakldagi nusxasi</span>
                      )}
                    </StyledFileOneInputContainer>
                  </label>
                </Grid>
