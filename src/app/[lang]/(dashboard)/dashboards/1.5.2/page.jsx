...
function Kpi152() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi152', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>1.5.2 / O‘quv va o‘quv-uslubiy ishlar /</Typography>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='O‘tkazilgan sayyor dars mashg‘uloti uchun 0.5 -ball' />
          <CardContent>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        id='titleInput'
                        label='Sayyor dars mavzusini kiriting'
                        placeholder='Sayyor dars mavzusi'
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        id='placeInput'
                        label='Sayyor dars o‘tlazilgan joyni kiriting'
                        placeholder='Sayyor dars o‘tlazilgan joy'
