...
const types = [
  `Xorijiy oliy ta’lim muassasalari bilan almashinuv dasturlarida ishtirok etganligi`,
  `Talabasi xorijiy oliy ta’lim muassasalari bilan almashinuv dasturlarida ishtirok etganligi `,
  `Xorijiy oliy ta’lim muassasalari konferensiyalarida ishtirok etganligi  (tinglovchi sifatida)`,
  `Xorijiy oliy ta’lim muassasalari konferensiyalarida ishtirok etganligi  (maruzachi sifatida)`,
  `Talabasi  xorijiy oliy ta’lim muassasalari konferensiyalarida ishtirok etganligi  (tinglovchi sifatida)`,
  `Talabasi  xorijiy oliy ta’lim muassasalari konferensiyalarida ishtirok etganligi  (maruzachi sifatida)`,
  `Xorijiy oliy ta’lim muassasalari ilmiy va o‘quv loyihalarda ishtirok etganligi`,
  `Talabasi  xorijiy oliy ta’lim muassasalari ilmiy va o‘quv loyihalarda ishtirok etganligi`
]
...
function Kpi34() {
  ...
  const uploadFile = async data => {
    ...
    try {
      const response = await fetch('/api/kpi34', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>3.4 / Xalqaro hamkorlikka oid ishlar /</Typography>
        <Typography variant='h6'>
          Xorijiy oliy ta’lim muassasalari bilan almashinuv dasturlari, konferensiyalar, ilmiy va o‘quv loyihalarda
          ishtirok etganligi Xalqaro hamkorlik bo‘limi tomonidan aniqlanadi va baholanadi
        </Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
                  ...
                  <label>
                    ...
                    <StyledFileOneInputContainer>
                      {selectedFileone ? (
                        ...
                        <span>Buyruqdan ko‘chirma pdf shaklda</span>
                      )}
                    </StyledFileOneInputContainer>
                  </label>
                </Grid>
