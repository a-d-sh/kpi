...
const schema = object({
  ...
  typetitle: string([minLength(1, 'This field is required'), minLength(3, 'Title must be at least 3 characters long')]),
  datesuccess: string([
...
function Kpi231() {
  ...
  const uploadFile = async () => {
    ...
    formData.append('typetitle', document.querySelector('#typetitleInput').value)

    try {
      const response = await fetch('/api/kpi231', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>2.3.1 / Ilmiy va innovatsiyalarga oid ishlar /</Typography>
        <Typography variant='h6'>
          Xalqaro va mahalliy konferensiyalarda o‘z maqolalari bilan ishtirok etganligi
        </Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        id='typeInput'
                        label='Anjuman turini kiriting'
                        placeholder='Anjuman turi'
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        fullWidth
                        id='typetitleInput'
                        label='Anjuman nomini kiriting'
                        placeholder='Anjuman nomi'
                        error={Boolean(errors.typetitle)}
                        helperText={errors.typetitle ? errors.typetitle.message : ''}
                        sx={{ marginBottom: 3 }}
                      />
                    )}
                  />
