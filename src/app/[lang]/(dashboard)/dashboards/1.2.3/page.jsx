...
function Kpi123() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi123', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>1.2.3 / O‘quv va o‘quv-uslubiy ishlar /</Typography>
        <Typography variant='h6'>Darslik chop etilganligi</Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='2-3 bosma taboq uchun -2 ball' />
          <CardContent>
