...
const types = [
  `Olib kelgan lekin mutaxassis yo‘nalishi tufayli bizda ishlay olmasligi aniqlanganlik`,
  `Olti oyda kamida 1 marotaba jalb etganlik`,
  `Yordamchi-o‘qituvchi bo‘lganligi`,
  `Xorijlik talabalarni jalb qilganlik`,
  `Olti oyda kamida 1 marotaba jalb etganligi xamda Xorijlik talabalarni universitetga jalb qilishda faollik`
]
...
function Kpi31() {
  ...
  const uploadFile = async data => {
    ...
    try {
      const response = await fetch('/api/kpi31', {
        method: 'POST',
        body: formData
      })
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>3.1 / Xalqaro hamkorlikka oid ishlar /</Typography>
        <Typography variant='h6'>
          Universitet proffessor o‘qituvchilari tomonidan xorijlik olimlar(expert, mutaxassis)ni dars mashg‘ulotlarini
          olib borishga jalb qilganligi yoki xorijlik olimlar(expert, mutaxassis)ga yordamchi o‘qituvchi bo‘lganligi
          yohud universitetga xorijlik talabalarni jalb qilganligi
        </Typography>
      </Grid>
      <Grid item xs={12}>
        <Card>
