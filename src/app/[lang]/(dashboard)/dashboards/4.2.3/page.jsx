...
function Kpi423() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi423', {
        method: 'POST',
        body: formData
      })
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          4.2.3 / Ma‘naviy-ma‘rifiy ishlar hamda mehnat va ijro intizomiga rioya etish/
        </Typography>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Professor-o‘qituvchi talaba-yoshlar uchun matbuot anjumani tashkil etishi: 0-2 ball' />
          <CardContent>
