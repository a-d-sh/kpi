...
function Kpi422() {
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await fetch('/api/kpi422', {
        method: 'POST',
        body: formData
      })
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          4.2.2 / Ma‘naviy-ma‘rifiy ishlar hamda mehnat va ijro intizomiga rioya etish/
        </Typography>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Professor-o‘qituvchi targ‘ibot guruhlarida ishtirok etishi: 0-1 ball' />
          <CardContent>
