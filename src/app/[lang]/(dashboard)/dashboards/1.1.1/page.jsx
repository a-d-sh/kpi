...
function Kpi111() {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>1.1.1 / O‘quv va o‘quv-uslubiy ishlar /</Typography>
      ...
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Bitta fan bo‘yicha to‘liq kontent (ma’ruza matni, savol va tarqatma materiallar, videodars tayyorlaganligi uchun – 5 ball)' />
          <CardContent>
